...
namespace Modules.Quiz.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260418122231_IncreaseSetCodeMaxLength")]
    partial class IncreaseSetCodeMaxLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Modules.Quiz.Core.QuestionAggregate.QuestionOption", b =>
                {
                    ...
                    b.Property<string>("OptionIdentifier")
                        .HasMaxLength(5)
            ...
            modelBuilder.Entity("Modules.Quiz.Core.QuestionAggregate.QuestionSet", b =>
                {
                    ...
                    b.Property<string>("ExpertiseFields")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

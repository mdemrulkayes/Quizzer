...
public sealed record UpdateOptionCommand(long QuestionId, long OptionId, string OptionText, bool IsAnswer) : ICommand<Result<QuestionOptionResponse>>, ICacheInvalidatingCommand
{
